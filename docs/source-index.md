...
| `docs/evidence/2026-06-26-breezyvoice-true-parallel-segment-batch-experiment-log.md` | True parallel segment batch runtime evidence: live concurrent segment dispatch, per-segment WAV files, ordered reconstruction, runtime validity, latency, and final batch status. |
